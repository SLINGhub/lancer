test_that("Able to plot dilution data with its statistical summar in a trellis table", {

  # Data Creation
  dilution_percent <- c(0, 10, 20, 25, 40, 50, 60,
                        75, 80, 100, 125, 150,
                        0, 10, 25, 40, 50, 60,
                        75, 80, 100, 125, 150)
  dilution_batch <- c("B1", "B1", "B1", "B1", "B1", "B1",
                      ...
                      "B2", "B2", "B2", "B2", "B2", "B2",
                      "B2", "B2", "B2", "B2", "B2")
  sample_name <- c("Sample_000a", "Sample_010a", "Sample_020a",
                   "Sample_025a", "Sample_040a", "Sample_050a",
                   "Sample_060a", "Sample_075a", "Sample_080a",
                   "Sample_100a", "Sample_125a", "Sample_150a",
                   "Sample_000a", "Sample_010b", "Sample_025b",
                   "Sample_040b", "Sample_050b", "Sample_060b",
                   "Sample_075b", "Sample_080b", "Sample_100b",
                   "Sample_125b", "Sample_150b")
  lipid1_area_saturated <- c(0, 5748124, 16616414, 21702718, 36191617,
                             49324541, 55618266, 66947588, 74964771,
                             75438063, 91770737, 94692060,
                             0, 5192648, 16594991, 32507833, 46499896,
                             55388856, 62505210, 62778078, 72158161,
                             78044338, 86158414)
  lipid2_area_linear <- c(0, 31538, 53709, 69990, 101977, 146436, 180960,
                          232881, 283780, 298289, 344519, 430432,
                          0, 25463, 63387, 90624, 131274, 138069,
                          205353, 202407, 260205, 292257, 367924)
  lipid3_area_lod <- c(0, 544, 397, 829, 1437, 1808, 2231,
                       3343, 2915, 5268, 8031, 11045,
                       0, 500, 903, 1267, 2031, 2100,
                       3563, 4500, 5300, 8500, 10430)
  lipid4_area_nonlinear <- c(0, 380519, 485372, 478770, 474467, 531640, 576301,
                             501068, 550201, 515110, 499543, 474745,
                             0, 197417, 322846, 478398, 423174, 418577,
