...
dilution_summary <- tibble::tibble(Transition_Name = transition_name,
                                   Corrcoef = corrcoef,
                                   Pra = pra,
...
Likewise for the excel output using the function `create_excel_report`, we can choose which
...
create_excel_report(dilution_classified,
