...
Here are some examples to plot dilution data via `plotly`
...
trellis_table_orig <- add_plotly_panel(dilution_table,
...
transition_annot <- tibble::tibble(Transition_Name = transition_name,
...
desc_vec <- c("Names of Transitions",
...
trellis_table_orig_converted <- trellis_table_orig  %>%
  ...
  convert_to_cog(cog_df = cog_df,
                 grouping_variable = c(col_name_vec,
                                       "Dilution_Batch_Name"),
...
view_trellis_html(trellis_table_orig_converted,
                  grouping_variable = c(col_name_vec,
                                       "Dilution_Batch_Name"),
