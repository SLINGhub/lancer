---
title: "Plots in ggplot2 Part 1"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Plots in ggplot2 Part 1}
...
dilution_classified <- curve_table %>%
...
Here is the output of `curve_table` and `dilution_classified` 
...
We then create the `ggplot` plots with `curve_table` and `dilution_classified`
...
```{r print ggplot plot 1}
#| fig.alt = "A ggplot of the Lipid1_B1's dilution curve
#|  and dilution statistics. This is the first row of
#|  the column panel."
ggplot_list_orig[[1]]
```

```{r print ggplot plot 2}
#| fig.alt = "A ggplot of the Lipid3_B2's dilution curve
#|  and dilution statistics. This is the seventh row of
#|  the column panel."
ggplot_list_orig[[7]]
```

To only plot the dilution curve without the summary table, set `plot_summary_table = FALSE`. You may not need to have any input for `dilution_summary`

```{r create ggplot table without the summary table}
...
```{r print ggplot plot without the summary table}
#| fig.alt = "A ggplot of the Lipid1_B1's dilution curve
#|  without dilution statistics. This is the first row of
#|  the column panel."
ggplot_list[[1]]
```
