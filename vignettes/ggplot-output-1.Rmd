...
#|  and curve statistics. This is the first row of
#|  the column panel."
ggplot_list_orig[[1]]
```

```{r print ggplot plot 2}
#| fig.alt = "A ggplot of the Curve_3_B2's curve
#|  and curve statistics. This is the seventh row of
#|  the column panel."
ggplot_list_orig[[7]]
```
...
#| fig.alt = "A ggplot of the Curve_1_B1's curve
#|  without curve statistics. This is the first row of
#|  the column panel."
ggplot_list[[1]]
```
