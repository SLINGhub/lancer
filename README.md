...
### Workflow 1 (Using **![R](https://latex.codecogs.com/png.latex?R "R")** and **![PRA](https://latex.codecogs.com/png.latex?PRA "PRA")**)
...
### Workflow 2 (Using ![R](https://latex.codecogs.com/png.latex?R "R"), ![PRA](https://latex.codecogs.com/png.latex?PRA "PRA") and Mandel)
  ...
  - If ![R
    ...
    "R \\ge{0.8}"), ![PRA
    \< 80](https://latex.codecogs.com/png.latex?PRA%20%3C%2080
    "PRA \< 80") and fit quadratic model and use Mandel test to see it
    is better
