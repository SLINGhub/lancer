...
R package used to validate if a quality control sample dilution curve is linear or has signal suppression.
...
The corresponding correlation coefficient are really high (>0.9) even though the curves are non-linear.
