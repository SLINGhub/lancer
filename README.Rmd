...
If you want to use a proper release version, referenced by a Git tag (example: 0.0.6) install the package as follows:
...
Using calibration curve data as a running example, an overview of the workflow is as follows
