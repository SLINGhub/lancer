...
The Pearson correlation coefficient has been used widely to test for linearity. However, it is insufficient as indicated in this [paper](https://www.sciencedirect.com/science/article/abs/pii/S0165993615301242)
...
One example is the use of the Percent Residual Accuracy found in [Logue, B. A. and Manandhar, E.](https://doi.org/10.1016/j.talanta.2018.07.046) which is more sensitive than Pearson correlation coefficient. Observe that the linear dilution curve gives a higher value compared to than the other two curves.
