 ...
 * If correlation coefficient $\ge{0.8}$, $PRA < 80$, classify as poor linearity.  
 * If correlation coefficient $\ge{0.8}$, $PRA \ge 80$, classify as good linearity.  

### Workflow 2 (Using R, PRA and Mandel)

 * If correlation coefficient < 0.8, classify as poor linearity.
 * If correlation coefficient >= 0.8, PRA < 80 and fit quadratic model and use Mandel test to see it is better 
 ...
 * If correlation coefficient >= 0.8, PRA >= 80, classify as good linearity
